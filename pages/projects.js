            ...
            <div className="flex flex-col w-full mt-10 space-y-7 ">
              ...
              >
                <div className="flex items-center justify-between w-full">
                  <div className="flex items-center justify-start space-x-2">
                    ...
                    <span className="text-base font-semibold tracking-wide text-gray-900 font-main">
                      copyhub.co
                    </span>
                  </div>
                  <span className="px-2 py-1 text-xs text-gray-900 bg-gray-100 rounded-md font-main">
                    Active
                  </span>
                </div>
                <div className={`px-8 ${!project9 && "hidden"}`}>
                  <h1 className="text-sm font-semibold text-gray-900 font-main">
                    What was it?
                  </h1>
                  ...
                  <div className="mt-2 text-sm leading-6 text-gray-500 font-main">
                    <a
              ...
              >
                <div className="flex items-center justify-between w-full">
                  ...
                  <span className="px-2 py-1 text-xs text-gray-900 bg-green-100 rounded-md font-main">
                    Sold
                  </span>
                </div>
              ...
              >
                <div className="flex items-center justify-between w-full">
                  ...
                  <div className="flex space-x-2">
                    <span className="px-2 py-1 text-xs text-green-900 bg-green-100 rounded-md font-main">
                      Sold
                    </span>
                    <span className="px-2 py-1 text-xs text-gray-900 bg-gray-100 rounded-md font-main">
                      2021
              ...
              >
                <div className="flex items-center justify-between w-full">
                  ...
                  <div className="flex space-x-2">
                    <span className="px-2 py-1 text-xs text-red-900 rounded-md font-main bg-red-50">
                      Shut down
                    </span>
                    <span className="px-2 py-1 text-xs text-gray-900 bg-gray-100 rounded-md font-main">
                      2020
                ...
                <div className={`px-8 ${!project4 && "hidden"}`}>
                  ...
                  <p className="mt-2 text-sm text-gray-500 font-main">
